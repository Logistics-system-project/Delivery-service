...
public enum ErrorCode {
	...
	UNSUPPORTED_DELIVERY_STATUS(NOT_FOUND, "존재하지 않는 배송 상태입니다."),
	DELIVERY_HISTORY_NOT_FOUND(NOT_FOUND, "존재하지 않는 배송 경로 기록입니다."),
	UNSUPPORTED_DELIVERY_HISTORY_STATUS(NOT_FOUND, "존재하지 않는 배송 경로 기록 상태입니다."),
